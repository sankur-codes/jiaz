...
class TestSprintCommand:
    ...
    def test_sprint_basic_call(
        ...
        sprint(wrt="status", show=None, output="json", config="default", mine=False)

        mock_analyze.assert_called_once_with(
            wrt="status", output="json", config="default", show=None, mine=False
        )

    @patch("jiaz.commands.analyze.sprint.analyze_sprint")
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_with_all_options(
        self, mock_get_active, mock_load_config, mock_analyze, mock_config
    ):
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_invalid_wrt_option(
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_invalid_output_format(
        self, mock_get_active, mock_load_config, mock_config
    ):
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_invalid_config(
        self, mock_get_active, mock_load_config, mock_config
    ):
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_show_field_parsing(
        self, mock_get_active, mock_load_config, mock_analyze, mock_config
    ):
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_predefined_show_field(
        self, mock_get_active, mock_load_config, mock_analyze, mock_config
    ):
        ...
        for wrt_option in valid_wrt_options:
            with patch("jiaz.commands.analyze.sprint.analyze_sprint"):
                with patch("jiaz.commands.analyze.sprint.load_config") as mock_load:
                    with patch(
                        "jiaz.commands.analyze.sprint.get_active_config"
                    ) as mock_active:
...
class TestSprintCommandIntegration:
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_workflow_integration(
        self, mock_get_active, mock_load_config, mock_analyze, mock_config
    ):
...
class TestSprintCommandEdgeCases:
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_none_show_field(
        self, mock_get_active, mock_load_config, mock_analyze, mock_config
    ):
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_single_show_field(
        self, mock_get_active, mock_load_config, mock_analyze, mock_config
    ):
        ...
        sprint(wrt="status", show="status", output="json", config="default", mine=False)
    ...
    @patch("jiaz.commands.analyze.sprint.load_config")
    @patch("jiaz.commands.analyze.sprint.get_active_config")
    def test_sprint_default_values(
        self, mock_get_active, mock_load_config, mock_analyze, mock_config
    ):
        ...
        sprint(wrt="status", show=None, output="json", config="test_config", mine=False)
