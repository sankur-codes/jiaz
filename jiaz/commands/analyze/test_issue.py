...
class TestIssueCommand:
    ...
    def test_issue_basic_call(self, mock_get_active, mock_load_config, mock_analyze, mock_config):
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_with_all_options(self, mock_get_active, mock_load_config, mock_analyze, mock_config):
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_mutual_exclusivity_error(self, mock_get_active, mock_load_config, mock_config):
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_invalid_output_format(self, mock_get_active, mock_load_config, mock_config):
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_show_field_parsing(self, mock_get_active, mock_load_config, mock_analyze, mock_config):
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_id_stripping(self, mock_get_active, mock_load_config, mock_analyze, mock_config):
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_predefined_show_field(self, mock_get_active, mock_load_config, mock_analyze, mock_config):
...
class TestIssueCommandIntegration:
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_workflow_integration(self, mock_get_active, mock_load_config, mock_analyze, mock_config):
    ...
    def test_issue_function_signature(self):
        ...
        expected_params = ['id', 'show', 'output', 'config', 'rundown', 'marshal_description']
...
class TestIssueCommandEdgeCases:
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_empty_show_field(self, mock_get_active, mock_load_config, mock_analyze, mock_config):
    ...
    @patch('jiaz.commands.analyze.issue.load_config')
    @patch('jiaz.commands.analyze.issue.get_active_config')
    def test_issue_single_show_field(self, mock_get_active, mock_load_config, mock_analyze, mock_config):
