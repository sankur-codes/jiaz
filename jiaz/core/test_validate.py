...
class TestValidationFunctions:
    ...
    def test_valid_jira_client_success(self, mock_typer, mock_requests, mock_jira):
        ...
        mock_typer.echo.assert_called_with("✅ JIRA authentication successful.", err=False)
    ...
    @patch('jiaz.core.validate.requests')
    @patch('jiaz.core.validate.typer')
    def test_valid_jira_client_authentication_error(self, mock_typer, mock_requests, mock_jira):
    ...
    def test_validate_sprint_config_missing_fields(self, mock_typer):
        ...
        mock_typer.echo.assert_called()
        assert "Missing required configuration field(s)" in str(mock_typer.echo.call_args)
