...
class JiraIssueAI:
    ...
    def standardize_description(self, description: str, issue_data, model: Optional[str] = None) -> str:
        ...
        issue_priority = getattr(issue_data.fields.priority, 'name', 'Unknown') if hasattr(issue_data.fields, 'priority') else 'Unknown'
        
        # Create comprehensive prompt for description standardization
        prompt = f"""
You are an expert in writing consistent and cleanly structured JIRA issue descriptions.
