...
from jiaz.core.issue_utils import (
    extract_sprints, extract_epic_progress, get_issue_children, 
    get_issue_fields, analyze_issue, _get_field_definitions
)
...
class TestIssueUtilsFunctions:
    ...
    def test_get_issue_children_status_missing(self):
        ...
        # No status field
        delattr(mock_issue.fields, 'status') if hasattr(mock_issue.fields, 'status') else None
    ...
    def test_get_issue_fields_required_fields(self, mock_jira_comms):
        ...
        assert "TEST-123" in result['key'] and "https://test.jira.com/browse/TEST-123" in result['key']
    ...
    def test_get_issue_fields_story_points(self, mock_jira_comms):
        ...
        result = get_issue_fields(mock_jira, mock_issue, ['story_points', 'original_story_points'])
    ...
    @patch('jiaz.core.issue_utils.JiraComms')
    @patch('jiaz.core.issue_utils.time_delta')
