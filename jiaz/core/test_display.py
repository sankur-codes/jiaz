...
class TestDisplayFunctions:
    ...
    def test_display_sprint_issue_table_format(
        self,
        mock_get_coloured,
        mock_filter_columns,
        mock_format_issue,
        ...
        mock_get_coloured.side_effect = (
            lambda table_content=None, header=None: table_content or header
        )
        ...
        mock_filter_columns.assert_called_once_with(
            sample_data_table, sample_headers, None
        )
    ...
    @patch("jiaz.core.display.format_issue_table")
    @patch("jiaz.core.display.filter_columns")
    def test_display_sprint_issue_json_format(
        self,
        mock_filter_columns,
        mock_format_issue,
        mock_format_json,
    ...
    @patch("jiaz.core.display.format_issue_table")
    @patch("jiaz.core.display.filter_columns")
    def test_display_sprint_issue_csv_format(
        self,
        mock_filter_columns,
        mock_format_issue,
        mock_format_csv,
    ...
    @patch("jiaz.core.display.filter_columns")
    @patch("jiaz.core.display.get_coloured")
    def test_display_sprint_status_table_format(
        self,
        mock_get_coloured,
        mock_filter_columns,
        mock_format_status,
    ...
    @patch("jiaz.core.display.filter_columns")
    @patch("jiaz.core.display.get_coloured")
    def test_display_sprint_owner_table_format(
        self,
        mock_get_coloured,
        mock_filter_columns,
        mock_format_owner,
    ...
    @patch("jiaz.core.display.filter_columns")
    @patch("jiaz.core.display.get_coloured")
    def test_display_sprint_epic_table_format(
        self,
        mock_get_coloured,
        mock_filter_columns,
        mock_format_epic,
    ...
    def test_display_issue_table_format(
        self,
        mock_jira_comms,
        mock_get_issue_fields,
        mock_issue_exists,
        mock_jira_ai,
        mock_tabulate,
        mock_print,
    ...
    @patch("jiaz.core.validate.issue_exists")
    @patch("jiaz.core.jira_comms.JiraComms")
    def test_display_issue_not_found(
        self, mock_jira_comms, mock_issue_exists, mock_echo
    ):
    ...
    def test_filter_columns_integration(self, sample_data_table, sample_headers):
        ...
        filtered_data, filtered_headers = filter_columns(
            sample_data_table, sample_headers, selected_columns
        )
    ...
    def test_story_points_coloring_logic(self, mock_colorize):
        ...
        with patch("jiaz.core.display.format_issue_table") as mock_format:
            with patch("jiaz.core.display.filter_columns") as mock_filter:
                with patch("jiaz.core.display.tabulate"):
                    with patch("jiaz.core.display.get_coloured") as mock_get_coloured:
                        with patch("jiaz.core.display.print"):
                            ...
                            mock_get_coloured.side_effect = (
                                lambda table_content=None, header=None: table_content
                                or header
                            )

                            display_sprint_issue(
                                data_with_changes, headers, "table", None
                            )
