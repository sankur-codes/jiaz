...
class TestJiraCommsInitialization:
    ...
    def test_init_success(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_init_with_different_config(self, mock_jira_client, mock_decode, mock_get_config):
        ...
        jira_comms = JiraComms('other_config')
...
class TestRateLimitedRequest:
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_rate_limited_request_no_delay_needed(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_rate_limited_request_with_delay(self, mock_jira_client, mock_decode, mock_get_config, mock_time, mock_sleep, mock_config):
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_rate_limited_request_queue_management(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
...
class TestCommentOperations:
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_get_comment_details_with_comments(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_get_comment_details_no_comments(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_get_comment_details_hours_ago(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_adding_comment_success(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
    ...
    def test_adding_comment_failure(self, mock_colorize, mock_typer, mock_jira_client, mock_decode, mock_get_config, mock_config):
...
class TestIssueOperations:
    ...
    def test_get_issue_success(self, mock_issue_exists, mock_jira_client, mock_decode, mock_get_config, mock_config):
    ...
    @patch('jiaz.core.jira_comms.typer')
    @patch('jiaz.core.jira_comms.colorize')
    def test_get_issue_not_exists(self, mock_colorize, mock_typer, mock_issue_exists, mock_jira_client, mock_decode, mock_get_config, mock_config):
...
class TestIntegration:
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_full_workflow(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_comment_workflow_integration(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
...
class TestErrorHandling:
    ...
    @patch('jiaz.core.jira_comms.decode_secure_value')
    @patch('jiaz.core.jira_comms.valid_jira_client')
    def test_rate_limited_request_exception_handling(self, mock_jira_client, mock_decode, mock_get_config, mock_config):
